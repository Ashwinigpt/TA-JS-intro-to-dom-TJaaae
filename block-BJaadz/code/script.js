...
// Set the border of the all the hr elements to "1px solid tomato"
  ...
  allHrsArray.forEach((hrs) => {
    hrs.style.border = "1px solid tomato";
  }) 
...
let box5 = document.querySelector('.five').style.borderRadius = '10px';

// Change the text color of box 6 to black.

let box6 = document.querySelector('.six').style.color = 'black';
...
allBox.forEach((v, i) => {
  if ((i + 1) % 2 !== 0) {
    v.style.backgroundColor = "aliceblue";
  } 
})
...
boxFive.append(anchor);
boxFive.append(anchor1);
